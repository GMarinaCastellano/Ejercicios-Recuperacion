...
<head>
    ...
    <title>Modificar Atracciones</title>
...
if(isset($_POST['nombre'])) {
    $nombre = $_POST['nombre'];
    $nombrePreparado = "UPDATE atracciones SET tematica = '".$nombre.
    "' WHERE id = '".$_POST['numeroAtraccion']."'";
...
<body>
    ...
    <form method="post" action="modificar_atraccion.php" >
